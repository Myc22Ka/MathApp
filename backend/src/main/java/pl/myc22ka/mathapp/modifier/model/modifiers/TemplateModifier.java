...
public class TemplateModifier extends Modifier {
     ...
     */
    public TemplateModifier(Topic topic, String modifierText, @NotNull Template template, String description) {
        super(null, modifierText, topic, "T" + template.getCode(),description);
        this.template = template;
    }

    /**
     * Copy constructor for TemplateModifier.
     *
     * @param original the original TemplateModifier to copy
     */
    public TemplateModifier(@NotNull TemplateModifier original) {
        super(original.getId(), original.getModifierText(), original.getTopic(), original.getTemplateCode(), original.getDescription());
